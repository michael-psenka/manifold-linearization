...
from manifold_curvature import ManifoldCurvature
import warnings
import tqdm
...
if __name__ == '__main__':
    ...
    mc.fit(X,svd_threshold=1,min_dim=7,n_iter=2)
    vae_mnist_curvature = mc.curvature(X)
    print(f'mean_curv: {vae_mnist_curvature.mean()}, std_curv: {vae_mnist_curvature.std()}')
